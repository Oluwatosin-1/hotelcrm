...
class ReservationUpdateView(View):
    ...
    def get(self, request, pk, *args, **kwargs):
        ...
        item_formset = MenuItemFormSet(instance=reservation, prefix="reservationitem_set")
    ...
    def post(self, request, pk, *args, **kwargs):
        ...
        item_formset = MenuItemFormSet(request.POST, instance=reservation, prefix="reservationitem_set")
        misc_formset = MiscFormSet(request.POST, instance=reservation, prefix="misccharge_set")

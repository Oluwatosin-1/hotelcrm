...
class DailySalesReportView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        aggregate = Invoice.objects.filter(invoice_date__date=today).aggregate(total=Sum('total_amount'))
...
class GeneralReportView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if period == 'daily':
            ...
            laundry_filter['created_at__date__range'] = (start_week.date(), end_week.date())
        else:
        ...
        context['general_report_data'] = [
            ...
            {"description": "Total Invoice Amount", "value": f"₦{context['total_invoice_amount']}"},
            {"description": "Total Laundry Clothes", "value": context['laundry_total_clothes']},
            {"description": "Used Laundry Clothes", "value": context['laundry_used_clothes']},
            {"description": "Returned/Unused Laundry Clothes", "value": context['laundry_returned_clothes']},
        ]

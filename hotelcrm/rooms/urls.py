...
urlpatterns = [
    ...
    path('categories/create/', RoomCategoryCreateView.as_view(), name='category-create'),
    path('categories/<int:pk>/edit/', RoomCategoryUpdateView.as_view(), name='category-edit'),
    path('categories/<int:pk>/delete/', RoomCategoryDeleteView.as_view(), name='category-delete'),

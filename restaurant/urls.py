...
from .views import (
    MenuCategoryListView, MenuCategoryCreateView, MenuCategoryUpdateView, MenuCategoryDeleteView,
    MenuItemListView, MenuItemCreateView, MenuItemUpdateView, MenuItemDeleteView,
    KOTListView, KOTCreateView, KOTDetailView
)
...
urlpatterns = [
    ...
    path('categories/create/', MenuCategoryCreateView.as_view(), name='category-create'),
    path('categories/<int:pk>/edit/', MenuCategoryUpdateView.as_view(), name='category-edit'),
    path('categories/<int:pk>/delete/', MenuCategoryDeleteView.as_view(), name='category-delete'),
    path('categories/<int:pk>/edit/', MenuCategoryUpdateView.as_view(), name='category-update'),

...
from .views import (
    ...
    ExpenseSubCategoryListView, ExpenseSubCategoryCreateView,
    ExpenseSubCategoryUpdateView, ExpenseSubCategoryDeleteView,
)
...
urlpatterns = [
    ...
    path('categories/<int:pk>/update/', ExpenseCategoryUpdateView.as_view(), name='category-update'),
    path('categories/<int:pk>/delete/', ExpenseCategoryDeleteView.as_view(), name='category-delete'),

    # Expense SubCategory routes
    path('subcategories/', ExpenseSubCategoryListView.as_view(), name='subcategory-list'),
    path('subcategories/create/', ExpenseSubCategoryCreateView.as_view(), name='subcategory-create'),
    path('subcategories/<int:pk>/update/', ExpenseSubCategoryUpdateView.as_view(), name='subcategory-update'),
    path('subcategories/<int:pk>/delete/', ExpenseSubCategoryDeleteView.as_view(), name='subcategory-delete'),
]
